...
//                SavedData.getInstance(OutgoingCallActivity.this).setString(AppConstants.USER_SIP_URI, accountID);
//                SavedData.getInstance(OutgoingCallActivity.this).setInt(AppConstants.CALL_ID, callID);
//                SavedData.getInstance(OutgoingCallActivity.this).setString(AppConstants.CALL_REMOTE_URI, remoteUri);
//                SavedData.getInstance(OutgoingCallActivity.this).setBoolean(AppConstants.CALL_IS_VIDEO, isVideo);
