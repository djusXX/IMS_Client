...
public class RejectIncomingCallUseCase extends CompletableUseCase<Call> {
    private final pjsua2ImsService service;

    @Inject
    public RejectIncomingCallUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, pjsua2ImsService service) {
    ...
    protected Completable buildUseCaseObservable(Call call) {
        return service.rejectIncomingCall(call);
    }
}
