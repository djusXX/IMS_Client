package ims_mobile_client.data.di;
...
public class RepositoryModule {
    ...
    @Singleton
    @Provides
    public ImsMobileClientRepository getRepo(LocalDataSource dataSource) {
        return new ImsMobileClientRepositoryImpl(dataSource);
    }
}
